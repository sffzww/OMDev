...
# installed.
TCL_PREFIX='/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tmp/x86_64-482-win32-seh-rt_v3-r0/build/tcl8.6.1/win -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt/include'
...
# compiled.
TCL_SRC_DIR='/tmp/src/tcl8.6.1'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tmp/x86_64-482-win32-seh-rt_v3-r0/build/tcl8.6.1/win -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/x86_64-482-win32-seh-rt_v3-r0/build/tcl8.6.1/win/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tmp/x86_64-482-win32-seh-rt_v3-r0/mingw64/opt/lib/libtclstub86.a'
