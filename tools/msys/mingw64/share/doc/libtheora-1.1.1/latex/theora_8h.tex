...
libtheora is the reference implementation for {\tt Theora}, a free video codec. Theora is derived from On2\textquotesingle{}s V\+P3 codec with improved integration with Ogg multimedia formats by {\tt Xiph.\+Org}.\subsection{Overview}\label{theora_8h_overview}
