...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'AR': 'ar',
 'ARFLAGS': 'rc',
 'ASDLGEN': 'python3.5 ../Python-3.5.0/Parser/asdl_c.py',
 'ASDLGEN_FILES': '../Python-3.5.0/Parser/asdl.py '
                  '../Python-3.5.0/Parser/asdl_c.py',
 'AST_ASDL': '../Python-3.5.0/Parser/Python.asdl',
 ...
 'BINLIBDEST': sys.prefix + '/lib/python3.5',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG -march=x86-64 -mtune=generic '
           '-O2 -pipe -fwrapv -D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG',
 'CFLAGSFORSHARED': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFIGURE_CPPFLAGS': '-I../Python-3.5.0/PC -D_FORTIFY_SOURCE=2 '
 ...
 'CONFINCLUDEPY': sys.prefix + '/include/python3.5m',
 'COREPYTHONPATH': ';plat-win',
 ...
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -IInclude -I../Python-3.5.0/Include -I../Python-3.5.0/PC '
 ...
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': sys.prefix + ' ' + sys.prefix + '/lib ' + sys.prefix + '/lib/python3.5 '
             '' + sys.prefix + '/lib/python3.5/lib-dynload',
 'DESTLIB': sys.prefix + '/lib/python3.5',
 'DESTPATH': '',
 'DESTSHARED': sys.prefix + '/lib/python3.5/lib-dynload',
 'DIRMODE': 755,
 ...
 'GRAMMAR_INPUT': '../Python-3.5.0/Grammar/Grammar',
 'HAVE_ACCEPT4': 0,
 'HAVE_ACOSH': 1,
 'HAVE_ADDRINFO': 1,
 'HAVE_ALARM': 0,
 ...
 'MACHDEP': 'win',
 'MACHDEPPATH': ';plat-win',
 'MACHDEPS': 'plat-win',
 'MACHDEP_OBJS': 'PC/dl_nt.o',
 'MACHDESTLIB': sys.prefix + '/lib/python3.5',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'x86_64-w64-mingw32-gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Python-3.5.0/Modules/makesetup',
 'MANDIR': sys.prefix + '/share/man',
 'MKDIR_P': '/usr/bin/mkdir -p',
 'MODLIBS': '-lws2_32',
 'MODOBJS': 'Modules/posixmodule.o  Modules/_threadmodule.o  '
            'Modules/signalmodule.o  Modules/winreg.o  Modules/msvcrtmodule.o  '
 ...
 'OPCODETARGETS_H': '\\',
 'OPCODE_H': '../Python-3.5.0/Include/opcode.h',
 'OPCODE_H_DIR': '../Python-3.5.0/Include',
 'OPCODE_H_GEN': 'python3.5  '
                 '../Python-3.5.0/Tools/scripts/generate_opcode_h.py '
                 '../Python-3.5.0/Lib/opcode.py '
                 '../Python-3.5.0/Include/opcode.h',
 'OPCODE_H_SCRIPT': '../Python-3.5.0/Tools/scripts/generate_opcode_h.py',
 'OPT': '-DNDEBUG',
 'OTHER_LIBTOOL_OPT': '',
 'PACKAGE_BUGREPORT': 0,
 'PACKAGE_NAME': 0,
 ...
 'PROFILE_TASK': '../Python-3.5.0/Tools/pybench/pybench.py -n 2 --with-gc '
                 '--with-syscheck',
 'PSRCS': '\\',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I../Python-3.5.0/Include -I../Python-3.5.0/PC '
                   '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
                   '-IC:/building/msys64/mingw64/include/ncursesw  -I. '
                   '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
                   '-IC:/building/msys64/mingw64/include/ncursesw  '
                   '-DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I../Python-3.5.0/Include -I../Python-3.5.0/PC '
                '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
                '-IC:/building/msys64/mingw64/include/ncursesw  -I. '
                '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
                '-IC:/building/msys64/mingw64/include/ncursesw',
 ...
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-35m',
 'SRCDIRS': 'Parser Grammar Objects Python Modules Mac Programs PC',
 'SRC_GDB_HOOKS': '../Python-3.5.0/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python.exe ../Python-3.5.0/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 3600,
 ...
 'VA_LIST_IS_ARRAY': 0,
 'VERSION': '3.5',
 'VPATH': 'C:/repo/mingw-w64-python3/src/Python-3.5.0',
 'VPATH_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.5.0',
 ...
 'abs_srcdir': 'C:/repo/mingw-w64-python3/src/Python-3.5.0',
 'abs_srcdir_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.5.0',
 'datarootdir': sys.prefix + '/share',
 'exec_prefix': '' + sys.prefix,
 'prefix': 'C:/building/msys64/mingw64',
 'prefix_b2h': 'C:/building/msys64/mingw64',
 'srcdir': 'C:/repo/mingw-w64-python3/src/Python-3.5.0',
 'srcdir_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.5.0'}
