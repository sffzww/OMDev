...
macro(_populate_WebKit_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5WebKit_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::WebKit PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5WebKit_LIB_DEPENDENCIES}${_list_sep}${_Qt5WebKit_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5WebKit_LIB_DEPENDENCIES}${_list_sep}${_Qt5WebKit_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::WebKit)
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt5WebKit_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            file(STRINGS ${pluginTarget} matched REGEX Qt5WebKit_PLUGINS)
            if (matched)
    ...
    macro(_populate_WebKit_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKit_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKit_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5WebKit_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_WebKit_target_properties(RELEASE "Qt5WebKit.dll" "libQt5WebKit.dll.a" )



    _populate_WebKit_target_properties(DEBUG "Qt5WebKitd.dll" "libQt5WebKitd.dll.a" )
