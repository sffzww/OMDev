...
macro(_populate_Enginio_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5Enginio_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::Enginio PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5Enginio_LIB_DEPENDENCIES}${_list_sep}${_Qt5Enginio_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5Enginio_LIB_DEPENDENCIES}${_list_sep}${_Qt5Enginio_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::Enginio)
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt5Enginio_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            file(STRINGS ${pluginTarget} matched REGEX Qt5Enginio_PLUGINS)
            if (matched)
    ...
    macro(_populate_Enginio_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Enginio_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Enginio_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5Enginio_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_Enginio_target_properties(RELEASE "Qt5Enginio.dll" "libQt5Enginio.dll.a" )



    _populate_Enginio_target_properties(DEBUG "Qt5Enginiod.dll" "libQt5Enginiod.dll.a" )
