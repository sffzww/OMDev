...
macro(_populate_3DRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt53DRender_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::3DRender PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt53DRender_LIB_DEPENDENCIES}${_list_sep}${_Qt53DRender_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt53DRender_LIB_DEPENDENCIES}${_list_sep}${_Qt53DRender_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::3DRender)
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt53DRender_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            file(STRINGS ${pluginTarget} matched REGEX Qt53DRender_PLUGINS)
            if (matched)
    ...
    macro(_populate_3DRender_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DRender_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DRender_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt53DRender_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_3DRender_target_properties(RELEASE "Qt53DRender.dll" "libQt53DRender.dll.a" )



    _populate_3DRender_target_properties(DEBUG "Qt53DRenderd.dll" "libQt53DRenderd.dll.a" )
