...
set(Qt5Qml_VERSION_STRING 5.6.0)
...
macro(_populate_Qml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5Qml_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::Qml PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5Qml_LIB_DEPENDENCIES}${_list_sep}${_Qt5Qml_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5Qml_LIB_DEPENDENCIES}${_list_sep}${_Qt5Qml_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/QtQml/5.6.0"
        "${_qt5Qml_install_prefix}/include/QtQml/5.6.0/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.0 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    macro(_populate_Qml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Qml_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Qml_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5Qml_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_Qml_target_properties(RELEASE "Qt5Qml.dll" "libQt5Qml.dll.a" )



    _populate_Qml_target_properties(DEBUG "Qt5Qmld.dll" "libQt5Qmld.dll.a" )
