...
macro(_populate_3DCore_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt53DCore_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::3DCore PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt53DCore_LIB_DEPENDENCIES}${_list_sep}${_Qt53DCore_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt53DCore_LIB_DEPENDENCIES}${_list_sep}${_Qt53DCore_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::3DCore)
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt53DCore_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            file(STRINGS ${pluginTarget} matched REGEX Qt53DCore_PLUGINS)
            if (matched)
    ...
    macro(_populate_3DCore_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DCore_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DCore_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt53DCore_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_3DCore_target_properties(RELEASE "Qt53DCore.dll" "libQt53DCore.dll.a" )



    _populate_3DCore_target_properties(DEBUG "Qt53DCored.dll" "libQt53DCored.dll.a" )
